...
public class CalcPanel extends JPanel {
    ...
    public CalcPanel(Runnable showForecast) {
        ...
        inputInner.add(start); inputInner.add(jdate); inputInner.add(enter);
        inputOuter.add(inputInner); inputOuter.add(incorrectEntry);
        ...
        this.add(descriptor); this.add(inputOuter); this.add(out); this.add(buttons);
    }
